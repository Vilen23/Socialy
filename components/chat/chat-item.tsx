...
export const ChatItem = ({
  ...
  return (
    <div className="relative group flex items-center hover:bg-black/5 p-4 transition w-full">
        ...
        <div className="flex flex-col w-full">
          ...
          {isImage && (
            <a
              ...
              className="relative aspect-square rounded-md mt-2 overflow-hidden border-none flex items-center bg-gray-500 h-48 w-48"
            >
              <Image
                src={fileUrl}
                alt={content}
          ...
          {!fileUrl && isEditing && (
            <Form {...form}>
                ...
                onSubmit={form.handleSubmit(onSubmit)}>
                    ...
                    <Button 
                    disabled={isLoading}
                    size="sm" variant="primary" className="bg-white text-black hover:bg-black hover:text-white border-none">
                        Save
                    </Button>
                </form>
      ...
      {canDeleteMessage && (
        <div className="hidden group-hover:flex items-center gap-x-2 absolute p-1 -top-2 right-5 bg-white dark:bg-zinc-800 border-black rounded-md">
            {canEditMessage && (
